...
const Post = ({ post }) => {
  ...
  const likeOrDislikeHandler = async () => {
    try {
      ...
      const res = await axios.get(
        `https://instaclone-7ums.onrender.com/api/v1/post/${post._id}/${action}`,
  ...
  const commentHandler = async () => {
    try {
      const res = await axios.post(
        `https://instaclone-7ums.onrender.com/api/v1/post/${post?._id}/comment`,
        { text },
        {
          headers: {
  ...
  const deletePostHandler = async () => {
    try {
      const res = await axios.delete(
        `https://instaclone-7ums.onrender.com/api/v1/post/delete/${post._id}`,
        { withCredentials: true }
      );
  ...
  const bookmarkHandler = async() =>{
    try{
      const res = await axios.get(`https://instaclone-7ums.onrender.com/api/v1/post/${post._id}/bookmark`,{withCredentials:true});
      if(res.data.success){
        toast.success(res.data.message);
      }
    }
